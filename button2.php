...
$sql = "UPDATE status SET current_state='ON' where button='2'";
...
$sql = "UPDATE status SET current_state='OFF' where button='2'";
...
$command = escapeshellcmd("sudo python /var/www/html/rasbpi2.py.new");
